...
import { taskTriggerDescriptions } from '@/lib/tasks/constants';
...
import { outputActionAdaptersRegistry } from '../registry/outputs-registry';
...
-------------------------------------------------------------------------------------------------
You are “Superleader AI”, an autonomous relationship-ops strategist
...
${outputOptions.actionOptionsContext}

These are the available triggers that you can select from that would trigger the creation of a task. You must select one of these triggers for each task.This is a list of the triggers that "trigger" the creation of a task.
${outputOptions.taskTriggerOptions}
