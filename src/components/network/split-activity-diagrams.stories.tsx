...
import { SplitActivityDiagramsRenderer } from './split-activity-diagrams';

const meta = {
  title: 'Network/SplitActivityDiagrams',
  component: SplitActivityDiagramsRenderer,
  parameters: {
    layout: 'centered'
  },
  decorators: [
...
} satisfies Meta<typeof SplitActivityDiagramsRenderer>;

export default meta;
type Story = StoryObj<typeof SplitActivityDiagramsRenderer>;
