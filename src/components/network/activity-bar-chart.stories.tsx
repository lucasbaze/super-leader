...
import { ActivityBarChartRenderer } from './activity-bar-chart';

const meta = {
  title: 'Network/ActivityBarChart',
  component: ActivityBarChartRenderer,
  parameters: {
    layout: 'centered'
  },
  decorators: [
...
} satisfies Meta<typeof ActivityBarChartRenderer>;

export default meta;
type Story = StoryObj<typeof ActivityBarChartRenderer>;
