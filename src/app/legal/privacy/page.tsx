    ...
    <div className='min-h-screen bg-white'>
      <div className='mx-auto max-w-4xl px-6 py-12'>
        ...
        <div className='space-y-8 text-gray-700'>
          ...
          <p className='mb-8'>
            At SuperLeader, we respect your privacy and are committed to protecting the personal
            information you share with us. This Privacy Policy explains how we collect, use, store,
            and share information when you access or use our website, application, and related
          ...
          <section>
            ...
            <p className='mb-4'>
              We collect personal and service-related information when you use SuperLeader,
              including:
            </p>
            <ul className='ml-6 list-disc space-y-2'>
              <li>Personal identifiers: name, email address, social handles</li>
              <li>
                Social and professional data: messages, notes, social profiles, calendar events
              </li>
              <li>
                Connected account data: information retrieved from Gmail, Outlook, Twitter,
                Calendly, and other integrated services
              </li>
          ...
          <section>
            ...
            <p>
              AI conversations and prompts are stored and may be reviewed to improve service
              reliability, fix bugs, and ensure quality. This data may be retained indefinitely,
              unless a user requests deletion.
            </p>
          </section>
          ...
          <section>
            ...
            <p className='mt-4'>
              These vendors may process or store personal data to the extent required for service
              delivery. We do not currently use third-party marketing cookies or external tracking
              tools like Segment or Mixpanel.
            </p>
          </section>
          ...
          <section>
            ...
            <p className='mb-4'>
              All personal data is encrypted at rest and in transit. While no system is entirely
              secure, we use best practices to safeguard your information.
            </p>
          ...
          <section>
            ...
            <p>
              All data is stored in the United States through third-party platforms, including
              Vercel, OpenAI, and Supabase, which may be layered on top of providers such as AWS.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              SuperLeader is not intended for use by children under 13. We do not knowingly collect
              or store data from children.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We may update this Privacy Policy at any time. The latest version will always be
              available via our website and app. Continued use of the Services indicates your
          ...
          <section>
            ...
            <p className='mb-4'>
              If you have questions or concerns about this Privacy Policy, or would like to submit a
          ...
          <section className='mt-8 border-t pt-8'>
            <p className='text-gray-700'>
              By using SuperLeader, you agree to the terms of this Privacy Policy.
            </p>
          </section>
        </div>
      </div>
